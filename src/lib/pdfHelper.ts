...
export async function exportTankersPDF(
  ...
  const getSignatureStyles = () => ({
    ...
    styles: { font: pdfFont, fontSize: isAr ? 8.5 : 8, cellPadding: { top: 4, bottom: 4, left: 3, right: 3 }, minCellHeight: 12, textColor: [51, 65, 85] as [number, number, number], lineColor: [226, 232, 240] as [number, number, number], lineWidth: 0.1 },
